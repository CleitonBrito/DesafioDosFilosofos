...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url(PUBLIC_LINK.'css/resultado_02.css'); ?>">
	...
	<div id="fundo" class="container">
		<div class="row">
			<div class="jantar col-7">
				<div class="imags">
					<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/Mesa_garfos.png'); ?>">

					<img class="img-jantar" id="filo1" src="<?= base_url(PUBLIC_LINK.'imagens/filo1.png'); ?>">
					<img class="img-jantar" id="filo2" src="<?= base_url(PUBLIC_LINK.'imagens/filo2.png'); ?>">
					<img class="img-jantar" id="filo3" src="<?= base_url(PUBLIC_LINK.'imagens/filo3.png'); ?>">
					<img class="img-jantar" id="filo4" src="<?= base_url(PUBLIC_LINK.'imagens/filo4.png'); ?>">
					<img class="img-jantar" id="filo5" src="<?= base_url(PUBLIC_LINK.'imagens/filo5.png'); ?>">

					<?php if(isset($_GET['filo1_comeu']) && $_GET['filo1_comeu'] == 0){ ?>
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/f1_morreu.png'); ?>">
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/Comida_f1.png'); ?>">
					<?php }if(isset($_GET['filo2_comeu']) && $_GET['filo2_comeu'] == 0){ ?>
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/f2_morreu.png'); ?>">
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/Comida_f2.png'); ?>">
					<?php }if(isset($_GET['filo3_comeu']) && $_GET['filo3_comeu'] == 0){ ?>
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/f3_morreu.png'); ?>">
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/Comida_f3.png'); ?>">
					<?php }if(isset($_GET['filo4_comeu']) && $_GET['filo4_comeu'] == 0){ ?>
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/f4_morreu.png'); ?>">
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/Comida_f4.png'); ?>">
					<?php }if(isset($_GET['filo5_comeu']) && $_GET['filo5_comeu'] == 0){ ?>
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/f5_morreu.png'); ?>">
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/Comida_f5.png'); ?>">
					<?php }
						if(isset($_GET['filo1_comeu']) && $_GET['filo1_comeu'] < 6){ ?>
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/comeu_pouco_f1.png'); ?>">
						<?php if(isset($_GET['filo1_morreu']) && $_GET['filo1_morreu'] == 1){ ?>
							<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/f1_morreu.png'); ?>">
						<?php } ?>
					<?php }if(isset($_GET['filo2_comeu']) && $_GET['filo2_comeu'] < 4){ ?>
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/comeu_pouco_f2.png'); ?>">
						<?php if(isset($_GET['filo2_morreu']) && $_GET['filo2_morreu'] == 1){ ?>
							<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/f2_morreu.png'); ?>">
						<?php } ?>
					<?php }if(isset($_GET['filo3_comeu']) && $_GET['filo3_comeu'] < 6){ ?>
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/comeu_pouco_f3.png'); ?>">
						<?php if(isset($_GET['filo3_morreu']) && $_GET['filo3_morreu'] == 1){ ?>
							<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/f3_morreu.png'); ?>">
						<?php } ?>
					<?php }if(isset($_GET['filo4_comeu']) && $_GET['filo4_comeu'] < 6){ ?>
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/comeu_pouco_f4.png'); ?>">
						<?php if(isset($_GET['filo4_morreu']) && $_GET['filo4_morreu'] == 1){ ?>
							<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/f4_morreu.png'); ?>">
						<?php } ?>
					<?php }if(isset($_GET['filo5_comeu']) && $_GET['filo5_comeu'] < 3){ ?>
						<img class="img-jantar" src="<?= base_url(PUBLIC_LINK.'imagens/comeu_pouco_f5.png'); ?>">
			...
			<div class="col-5">
				<div class="introducao">
					...
					if(isset($_GET['acertou']) && $_GET['acertou'] == 1){ ?>
						<img id="resultado-certo" class="resultado" src="<?= base_url(PUBLIC_LINK.'imagens/resultado_certo.png'); ?>">
					<?php }else{ ?>
						<img id="resultado-errado" class="resultado" src="<?= base_url(PUBLIC_LINK.'imagens/resultado_errado.png'); ?>">
					<?php } ?>
