...
<body>
				...
				<div class="introducao">
					...
					<div class="row">
						<div id="contador">
							...
							<img class="relogio-1" src="<?= base_url('public/imagens/relogio.png'); ?>">
							</div>
	...
	<script id="link"
        type="text/javascript" src="<?= base_url('public/js/regra_01.js'); ?>"
        baselink="<?= base_url() ?>"
    ></script>
	<script type="text/javascript" src="<?= base_url('public/js/cronometro_jogo1.js'); ?>"></script>
	<script type="text/javascript" src="<?= base_url('public/js/jogo01.js'); ?>"></script>
	<script>
		function home(){
