...
<body>
	<div id="fundo" class="container">
		<div class="row">
			<div class="jantar col-7">
				<div class="imags">
					<img class="img-jantar" src="<?= base_url('../css/ojantar.png'); ?>">
				...
				<div class="introducao">
					...
					<div class="row">
						<div id="contador">
							...
							<img class="relogio-1" src="<?= base_url('imagens/relogio.png'); ?>">
							</div>
	...
	<script src="<?= base_url('js/regra_01.js'); ?>"></script>
	<script src="<?= base_url('js/cronometro_jogo1.js'); ?>"></script>
	<script src="<?= base_url('js/jogo01.js'); ?>"></script>
</body>
</html>