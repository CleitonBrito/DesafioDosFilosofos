...
<body>
					...
					<div class="row">
						<div class="col-6">
							<div id="contador">
					            ...
					            <div class="reloj" id="Segundos">:20</div>
					        </div>
				        </div>
    ...
    <script id="link"
        type="text/javascript" src="<?= base_url(PUBLIC_LINK.'js/regra_02.js'); ?>"
        baselink="<?= base_url() ?>"
    ></script>
	<script type="text/javascript" src="<?= base_url(PUBLIC_LINK.'js/cronometro_jogo2.js'); ?>"></script>
	<script type="text/javascript" src="<?= base_url(PUBLIC_LINK.'js/jogo02.js'); ?>"></script>
	<script>
		function home(){
