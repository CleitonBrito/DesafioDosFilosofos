...
<body>
	...
	<script type="text/javascript" src="<?= base_url('js/regra_02.js'); ?>"></script>
	<script type="text/javascript" src="<?= base_url('js/cronometro_jogo2.js'); ?>"></script>
	<script type="text/javascript" src="<?= base_url('js/jogo02.js'); ?>"></script>
</body>
</html>