...
<body>
    ...
    <script id="link"
        type="text/javascript" src="<?= base_url('public/js/regra_02.js'); ?>"
        baselink="<?= base_url() ?>"
    ></script>
	<script type="text/javascript" src="<?= base_url('public/js/cronometro_jogo2.js'); ?>"></script>
	<script type="text/javascript" src="<?= base_url('public/js/jogo02.js'); ?>"></script>
	<script>
		function home(){
