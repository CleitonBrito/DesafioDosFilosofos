...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url('public/css/jogo01.css'); ?>">
...
<body>
	<div id="fundo" class="container">
		<div class="row">
			<div class="jantar col-7">
				<div class="imags">
					<img class="img-jantar" src="<?= base_url('public/imagens/ojantar.png'); ?>">

					<img class="img-jantar" id="filo1" style="display: block;" src="<?= base_url('public/imagens/filo1.png'); ?>">
					<img class="img-jantar" id="filo2" style="display: block;" src="<?= base_url('public/imagens/filo2.png'); ?>">
					<img class="img-jantar" id="filo3" style="display: block;" src="<?= base_url('public/imagens/filo3.png'); ?>">
					<img class="img-jantar" id="filo4" style="display: block;" src="<?= base_url('public/imagens/filo4.png'); ?>">
					<img class="img-jantar" id="filo5" style="display: block;" src="<?= base_url('public/imagens/filo5.png'); ?>">
			...
			<div class="col-5">
				...
				<div class="introducao">
					...
					<div class="row">
						<div class="col-6">
							<div id="contador">
								<img class="relogio" src="<?= base_url('public/imagens/relogio.png'); ?>">
					            <div class="reloj" id="Minutos">01</div>
					            <div class="reloj" id="Segundos">:45</div>
					        </div>
				        </div>
				        <div class="col-6 coracao">
				        	<img id="img-coracao" src="<?= base_url('public/imagens/coracao.png'); ?>">
				        	<h6 id="vidas">4</h6>
				        </div>
						<div class="col-12">
							<div class="col-3">
				...
				<div class="introducao">
					<div class="row">
						<div class="col-4">
							<img id="sombra-0" style="display: block" class="filosofo_sombra" src="<?= base_url('public/imagens/filosofo_sombra.png') ?>">
							<img id="sombra-1" style="display: contents;" class="filosofo_sombra" src="<?= base_url('public/imagens/Filosofo1.png'); ?>">
							<img id="sombra-2" style="display: contents;" class="filosofo_sombra" src="<?= base_url('public/imagens/Filosofo2.png'); ?>">
							<img id="sombra-3" style="display: contents;" class="filosofo_sombra" src="<?= base_url('public/imagens/Filosofo3.png'); ?>">
							<img id="sombra-4" style="display: contents;" class="filosofo_sombra" src="<?= base_url('public/imagens/Filosofo4.png'); ?>">
							<img id="sombra-5" style="display: contents;" class="filosofo_sombra" src="<?= base_url('public/imagens/Filosofo5.png'); ?>">
						</div>
						<div class="col-8">
    ...
    <script id="link"
        type="text/javascript" src="<?= base_url('public/js/regra_03.js'); ?>"
        baselink="<?= base_url() ?>"
    ></script>
	<script type="text/javascript" src="<?= base_url('public/js/cronometro_jogo3.js'); ?>"></script>
	<script type="text/javascript" src="<?= base_url('public/js/jogo03.js'); ?>"></script>
	<script>
		function home(){
