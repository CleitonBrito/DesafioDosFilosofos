...
<body>
		...
		<div class="row">
			<div class="jantar col-7">
				<div class="imags">
					...
					<img class="img-jantar" id="filo1_pensando" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo1_pensando.png'); ?>">
					<img class="img-jantar" id="filo2_pensando" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo2_pensando.png'); ?>">
					<img class="img-jantar" id="filo3_pensando" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo3_pensando.png'); ?>">
					<img class="img-jantar" id="filo4_pensando" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo4_pensando.png'); ?>">
					<img class="img-jantar" id="filo5_pensando" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo5_pensando.png'); ?>">

					<img class="img-jantar" id="filo1_comendo" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo1_comendo.png'); ?>">
					<img class="img-jantar" id="filo2_comendo" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo2_comendo.png'); ?>">
					<img class="img-jantar" id="filo3_comendo" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo3_comendo.png'); ?>">
					<img class="img-jantar" id="filo4_comendo" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo4_comendo.png'); ?>">
					<img class="img-jantar" id="filo5_comendo" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo5_comendo.png'); ?>">

					<img class="img-jantar" id="filo1_garfoEsquerdo" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo1_garfoEsquerdo.png'); ?>">
					<img class="img-jantar" id="filo2_garfoEsquerdo" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo2_garfoEsquerdo.png'); ?>">
					<img class="img-jantar" id="filo3_garfoEsquerdo" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo3_garfoEsquerdo.png'); ?>">
					<img class="img-jantar" id="filo4_garfoEsquerdo" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo4_garfoEsquerdo.png'); ?>">
					<img class="img-jantar" id="filo5_garfoEsquerdo" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo5_garfoEsquerdo.png'); ?>">

					<img class="img-jantar" id="filo1_garfoDireito" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo1_garfoDireito.png'); ?>">
					<img class="img-jantar" id="filo2_garfoDireito" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo2_garfoDireito.png'); ?>">
					<img class="img-jantar" id="filo3_garfoDireito" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo3_garfoDireito.png'); ?>">
					<img class="img-jantar" id="filo4_garfoDireito" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo4_garfoDireito.png'); ?>">
					<img class="img-jantar" id="filo5_garfoDireito" style="display: contents;" src="<?= base_url(PUBLIC_LINK.'imagens/filo5_garfoDireito.png'); ?>">

					<img class="img-jantar" id="garfo1" style="display: block;" src="<?= base_url(PUBLIC_LINK.'imagens/garfo1.png'); ?>">
					<img class="img-jantar" id="garfo2" style="display: block;" src="<?= base_url(PUBLIC_LINK.'imagens/garfo2.png'); ?>">
					<img class="img-jantar" id="garfo3" style="display: block;" src="<?= base_url(PUBLIC_LINK.'imagens/garfo3.png'); ?>">
					<img class="img-jantar" id="garfo4" style="display: block;" src="<?= base_url(PUBLIC_LINK.'imagens/garfo4.png'); ?>">
					<img class="img-jantar" id="garfo5" style="display: block;" src="<?= base_url(PUBLIC_LINK.'imagens/garfo5.png'); ?>">
				</div>
			...
			<div class="col-5">
				...
				<div class="introducao">
					...
					<div class="row">
						<div class="col-6">
							<div id="contador">
								<img class="relogio" src="<?= base_url(PUBLIC_LINK.'imagens/relogio.png'); ?>">
					            <div class="reloj" id="Minutos">01</div>
					            <div class="reloj" id="Segundos">:45</div>
					        </div>
				        </div>
				        <div class="col-6 coracao">
				        	<img id="img-coracao" src="<?= base_url(PUBLIC_LINK.'imagens/coracao.png'); ?>">
				        	<h6 id="vidas">4</h6>
				        </div>
						<div class="col-12">
							<div class="col-3">
    ...
    <script id="link"
        type="text/javascript" src="<?= base_url(PUBLIC_LINK.'js/regra_03.js'); ?>"
        baselink="<?= base_url() ?>"
    ></script>
	<script type="text/javascript" src="<?= base_url(PUBLIC_LINK.'js/cronometro_jogo3.js'); ?>"></script>
	<script type="text/javascript" src="<?= base_url(PUBLIC_LINK.'js/jogo03.js'); ?>"></script>
	<script>
		function home(){
		...
		function voltar(){
			window.location.href = "<?= base_url('Jantar/Desafio/3'); ?>";
		}
	</script>
</body>
</html>