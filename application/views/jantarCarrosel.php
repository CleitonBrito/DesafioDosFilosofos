...
<body>
	<div id="fundo" class="container">
				...
				<div class="botoes">
						<div style="display: none;" id="passa-slide" class="col-5 botoes"><a href="#carouselExampleIndicators" data-slide="prev"><button class="botao-anterior btn btn-sucess">Anterior</button></a></div>
						<div style="display: flex;" id="passa-pg" class="col-5 botoes"><a href="<?= base_url(); ?>"><button class="botao-anterior btn btn-sucess">Anterior</button></a></div>
						<div style="display: flex;" id="volta-slide" class="col-5 botoes"><a href="#carouselExampleIndicators" data-slide="next"><button class="botao-proximo btn btn-sucess">Próximo</button></a></div>
						<div style="display: none;" id="volta-pg" class="col-5 botoes"><a href="<?= base_url('/Jantar/Desafio/1'); ?>"><button class="botao-proximo btn btn-sucess">Próximo</button></a></div>
					</div>
				</div>
	</div>
