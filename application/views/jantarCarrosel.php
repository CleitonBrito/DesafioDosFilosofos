...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url(PUBLIC_LINK.'css/carrossel.css'); ?>">
...
<body>
		...
		<div data-interval="8000" id="carousel" class="carousel slide" data-ride="carousel">
		  ...
		  <div class="carousel-inner">
		    <div id="primeiro" class="carousel-item active">
		      <img class="d-block w-100" src="<?= base_url(PUBLIC_LINK.'imagens/teste.png'); ?>" alt="Primeiro Slide">
		    </div>
		    <div class="carousel-item">
		      <img class="d-block w-100" src="<?= base_url(PUBLIC_LINK.'imagens/teste1.gif'); ?>" alt="Segundo Slide">
		    </div>
		    <div class="carousel-item">
		      <img class="d-block w-100" src="<?= base_url(PUBLIC_LINK.'imagens/teste2.gif'); ?>" alt="Terceiro Slide">
		    </div>
		    <div class="carousel-item">
		      <img class="d-block w-100" src="<?= base_url(PUBLIC_LINK.'imagens/teste3.gif'); ?>" alt="Quarto Slide">
		    </div>
		    <div id="ultimo" class="carousel-item">
		      <img class="d-block w-100" src="<?= base_url(PUBLIC_LINK.'imagens/teste4.png'); ?>" alt="Quinto Slide">
		    </div>
		  </div>
		<div class="botoes">
	...
	<div class="footer">
		<div class="row">
			<div class="col">
      			...
      			<a class="link" onclick="adiante();"><img class="seta" src="<?= base_url(PUBLIC_LINK.'imagens/seta_adiante.png'); ?>"></a>
			</div>
			<div class="col">
	...
	<script src="<?= base_url(PUBLIC_LINK.'js/carrossel.js'); ?>"></script>
	<script>
		function voltar(){
