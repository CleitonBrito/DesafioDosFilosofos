...
<body>
	...
	<script type="text/javascript" src="<?= base_url('js/regra_02'); ?>"></script>
	<script type="text/javascript" src="<?= base_url('js/cronometro_jogo2'); ?>"></script>
	<script type="text/javascript" src="<?= base_url('js/jogo02'); ?>"></script>
</body>
</html>