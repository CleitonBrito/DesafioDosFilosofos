	...
	function contabiliza(filo, acao){
		...
		if(acao == 1){
			if(filo == 1){
				...
				qtd_comeu.innerHTML = "Comeu: "+filo1_comeu+" de 1";
				qtd_pensou.innerHTML = "Pensou: "+filo1_pensou+" de 1";
			}else if(filo == 2){
				$('#qtd-comeu').innerHTML = filo2_comeu++;
				qtd_comeu.innerHTML = "Comeu: "+filo2_comeu+" de 1";
				qtd_pensou.innerHTML = "Pensou: "+filo2_pensou+" de 1";
			}
			else if(filo == 3){
				$('#qtd-comeu').innerHTML = filo3_comeu++;
				qtd_comeu.innerHTML = "Comeu: "+filo3_comeu+" de 1";
				qtd_pensou.innerHTML = "Pensou: "+filo3_pensou+" de 1";
			}
			else if(filo == 4){
				$('#qtd-comeu').innerHTML = filo4_comeu++;
				qtd_comeu.innerHTML = "Comeu: "+filo4_comeu+" de 1";
				qtd_pensou.innerHTML = "Pensou: "+filo4_pensou+" de 1";
			}
			else if(filo == 5){
				$('#qtd-comeu').innerHTML = filo5_comeu++;
				qtd_comeu.innerHTML = "Comeu: "+filo5_comeu+" de 1";
				qtd_pensou.innerHTML = "Pensou: "+filo5_pensou+" de 1";
			}
		}else if(acao == 2){
			if(filo == 1){
